    ...
    return (
        <div className="flex-1 bg-[var(--theme-bg)] transition-colors duration-500 p-3 lg:p-8 overflow-y-auto custom-scrollbar h-full flex flex-col gap-4 lg:gap-6 relative pb-20 lg:pb-5">
            <header className="flex justify-between items-end shrink-0">
                ...
                <div className="hidden lg:flex bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 p-1 rounded-xl">
