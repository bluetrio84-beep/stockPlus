...
const AdminIntelligenceDashboard = () => {
    ...
    const renderSupplyHelp = () => (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 animate-in fade-in duration-200">
            ...
            <div className="relative w-full max-w-md bg-[var(--theme-header)] transition-colors duration-500 border border-slate-700 rounded-3xl shadow-2xl overflow-hidden p-6 animate-in zoom-in-95 duration-200">
                ...
                <div className="space-y-3 max-h-[60vh] overflow-y-auto custom-scrollbar-thin pr-1">
                    <div className="bg-[var(--theme-bg)] transition-colors duration-500/50 p-3 rounded-2xl border border-rose-500/20">
                    ...
                    <div className="bg-[var(--theme-bg)] transition-colors duration-500/50 p-3 rounded-2xl border border-cyan-500/20">
                    ...
                    <div className="bg-[var(--theme-bg)] transition-colors duration-500/50 p-3 rounded-2xl border border-indigo-500/20">
                    ...
                    <div className="bg-[var(--theme-bg)] transition-colors duration-500/50 p-3 rounded-2xl border border-amber-500/20">
                    ...
                    <div className="bg-[var(--theme-bg)] transition-colors duration-500/50 p-3 rounded-2xl border border-emerald-500/20">
    ...
    const renderHitRateHelp = () => (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 animate-in fade-in duration-200">
            ...
            <div className="relative w-full max-w-md bg-[var(--theme-header)] transition-colors duration-500 border border-slate-700 rounded-3xl shadow-2xl overflow-hidden p-6 animate-in zoom-in-95 duration-200">
                ...
                <div className="bg-[var(--theme-bg)] transition-colors duration-500/50 p-4 rounded-2xl border border-emerald-500/20 leading-relaxed">
        ...
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 animate-in fade-in duration-200">
            ...
            <div className="relative w-full max-w-md bg-[var(--theme-header)] transition-colors duration-500 border border-slate-700 rounded-3xl shadow-2xl overflow-hidden p-6 animate-in zoom-in-95 duration-200">
                ...
                <div className="space-y-4">
                    <div className="bg-[var(--theme-bg)] transition-colors duration-500/50 p-4 rounded-2xl border border-indigo-500/20 leading-relaxed">
    ...
    const renderRotationHelp = () => (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 animate-in fade-in duration-200">
            ...
            <div className="relative w-full max-w-md bg-[var(--theme-header)] transition-colors duration-500 border border-slate-700 rounded-3xl shadow-2xl overflow-hidden p-6 animate-in zoom-in-95 duration-200">
                ...
                <div className="space-y-4">
                    <div className="bg-[var(--theme-bg)] transition-colors duration-500/50 p-4 rounded-2xl border border-yellow-500/20 leading-relaxed">
                    ...
                    <div className="bg-[var(--theme-header)] transition-colors duration-500/50 p-3 rounded-xl border border-[var(--theme-border)] transition-colors duration-500">
    ...
    const renderAiTracker = () => (
        <div className="bg-[var(--theme-header)] transition-colors duration-500 border border-indigo-500/30 rounded-2xl p-4 shadow-lg shadow-indigo-900/10 flex flex-col gap-3 h-full min-h-[300px]">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar-thin space-y-2 pr-1">
                {data.aiSignals && data.aiSignals.length > 0 ? (
                    data.aiSignals.map((sig, i) => {
                        ...
                        return (
                            <div key={i} className={classNames("bg-[var(--theme-bg)] transition-colors duration-500/50 border rounded-xl p-2.5 flex items-center justify-between group transition-all animate-in slide-in-from-right-4 duration-300", colors.border, `hover:border-${colors.bg.split('-')[1]}-500/50`)}>
    ...
    const renderAiStrategy = () => {
        ...
        return (
            <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500 h-full overflow-y-auto custom-scrollbar p-1 pb-10">
                <div className="bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-3xl p-6 shadow-2xl flex items-center justify-between">
                ...
                <div className="bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-3xl p-8 flex flex-col items-center shadow-2xl relative overflow-hidden shrink-0">
                    ...
                    <div className="relative w-64 h-32 overflow-hidden">
                        <div className="absolute inset-0 border-[18px] border-[var(--theme-border)] transition-colors duration-500 rounded-t-full"></div>
                    ...
                    <p className={classNames("mt-6 text-[11px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full bg-[var(--theme-bg)] transition-colors duration-500/50 border border-[var(--theme-border)] transition-colors duration-500", sentimentColor)}>{sentiment}</p>
                </div>

                <div className="bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-3xl p-6 shadow-2xl flex flex-col gap-4">
                    <div className="flex items-center justify-between pb-2 border-b border-[var(--theme-border)] transition-colors duration-500/50">
                        <div className="flex items-center gap-2">
                    ...
                    <div className="space-y-3">
                        {rotationList.length > 0 ? rotationList.map((sect, i) => (
                            <div key={i} className="bg-[var(--theme-bg)] transition-colors duration-500/50 border border-[var(--theme-border)] transition-colors duration-500 hover:border-indigo-500/50 rounded-xl p-4 flex items-center justify-between group transition-all">
        ...
        <>
            <div className={classNames("flex flex-col gap-4 shrink-0", mobileTab !== 'overview' && 'hidden lg:flex')}>
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                    <div className="bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] p-3 rounded-xl shadow-lg flex flex-col justify-center h-18 lg:h-20 transition-colors"><span className="text-[9px] font-black text-slate-500 uppercase mb-1 transition-colors">상승 업종 비율 (ADR)</span><div className="flex items-baseline justify-between transition-colors"><span className="text-xl lg:text-2xl font-black text-rose-500">{data.breadth?.rising_count || 0} <span className="text-[8px] text-slate-600">SEC</span></span><span className="text-[10px] font-black text-indigo-600 transition-colors">{((data.breadth?.rising_count / (data.breadth?.rising_count + data.breadth?.falling_count || 1)) * 100).toFixed(0)}%</span></div></div>
                    <div className="bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] p-3 rounded-xl shadow-lg flex flex-col justify-center h-18 lg:h-20 transition-colors"><span className="text-[9px] font-black text-slate-500 uppercase mb-1 transition-colors">하락 비중</span><div className="flex items-baseline justify-between transition-colors"><span className="text-xl lg:text-2xl font-black text-blue-600">{data.breadth?.falling_count || 0} <span className="text-[8px] text-slate-600">SEC</span></span><span className="text-[10px] font-black text-slate-500 transition-colors">{((data.breadth?.falling_count / (data.heatmap?.length || 1)) * 100).toFixed(0)}%</span></div></div>
                    <div className="bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] p-3 rounded-xl shadow-lg flex flex-col justify-center h-18 lg:h-20 transition-colors"><span className="text-[9px] font-black text-slate-500 uppercase mb-1 transition-colors">시장 강도</span><div className="flex items-center gap-2 transition-colors"><TrendingUp size={16} className="text-indigo-600" /><span className="text-xl lg:text-2xl font-black text-indigo-600 font-mono transition-colors">{((data.breadth?.rising_count / (data.breadth?.falling_count || 1)) * 100).toFixed(1)}%</span></div></div>
                    <div className="bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] p-3 rounded-xl shadow-lg flex flex-col justify-center h-18 lg:h-20 overflow-hidden transition-colors"><span className="text-[9px] font-black text-slate-500 uppercase mb-1 transition-colors">Top Sector</span><div className="flex flex-col justify-center h-full transition-colors">{data.heatmap && data.heatmap.length > 0 ? (<><span className="text-[11px] lg:text-sm font-black text-[var(--theme-text)] truncate w-full transition-colors">{data.heatmap[0].industry_name}</span><span className={classNames("text-[10px] lg:text-xs font-black mt-0.5 transition-colors", parseFloat(data.heatmap[0].change_rate) > 0 ? "text-rose-600" : "text-blue-600")}>{parseFloat(data.heatmap[0].change_rate) > 0 ? '+' : ''}{data.heatmap[0].change_rate}%</span></>) : (<div className="text-[9px] text-slate-500 font-bold transition-colors">Wait...</div>)}</div></div>
                </div>
            ...
            <div className="grid grid-cols-12 gap-4 lg:gap-6 flex-1 min-h-0 overflow-hidden">
                ...
                <div id="industry-heatmap-area" className={classNames("col-span-12 lg:col-span-6 bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-2xl lg:rounded-3xl p-4 lg:p-6 shadow-2xl flex flex-col h-full overflow-hidden", mobileTab !== 'heatmap' && 'hidden lg:flex')}>
                ...
                <div className={classNames("col-span-12 lg:col-span-3 bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-2xl lg:rounded-3xl p-4 lg:p-6 shadow-2xl flex flex-col h-full overflow-hidden", mobileTab !== 'themes' && 'hidden lg:flex')}>
                    ...
                    <div className="space-y-2 lg:space-y-3 overflow-y-auto custom-scrollbar-thin pr-1 flex-1 pb-2">
                        {paginatedThemes?.map((theme, idx) => (
                            <div key={idx} className="bg-[var(--theme-bg)] transition-colors duration-500/50 border border-[var(--theme-border)] transition-colors duration-500/50 rounded-xl lg:rounded-2xl p-3 flex flex-col gap-1.5 hover:border-indigo-500/50 transition-all shadow-inner group">
                                ...
                                <div className="bg-[var(--theme-header)] transition-colors duration-500 rounded-lg border border-[var(--theme-border)] transition-colors duration-500 w-full p-2 flex items-start gap-2"><Target size={10} className="text-cyan-500 shrink-0 mt-1" /><span className="text-[9px] font-bold text-slate-300 break-all leading-relaxed">{theme.lead_stocks || '-'}</span></div>
                            </div>
                        ))}
                    </div>
                </div>
    ...
    return (
        <div className="flex-1 bg-[var(--theme-bg)] transition-colors duration-500 p-3 lg:p-8 overflow-y-auto custom-scrollbar h-full flex flex-col gap-4 lg:gap-6 relative pb-20 lg:pb-5">
            <header className="flex justify-between items-end shrink-0">
                <div><div className="flex items-center gap-3 mb-1"><div className="p-1.5 bg-indigo-600/20 rounded-lg border border-indigo-500/30 transition-colors"><LayoutDashboard className="text-[var(--theme-point)]" size={20} /></div><h1 className="text-lg lg:text-2xl font-black text-[var(--theme-text)] tracking-tight uppercase italic transition-colors">Intelligence</h1></div><p className="text-slate-500 text-[9px] lg:text-xs font-bold uppercase tracking-widest opacity-80 transition-colors">v1 Advanced Engine</p></div>
                <div className="hidden lg:flex bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] p-1 rounded-xl shadow-sm">
                    <button onClick={() => setActiveTab('monitor')} className={classNames("px-4 py-1.5 rounded-lg text-[10px] font-black transition-all flex items-center gap-2 transition-colors", activeTab === 'monitor' ? "bg-[var(--theme-point)] text-white shadow-lg" : "text-slate-500 hover:text-[var(--theme-text)]")}><Activity size={12}/> MONITOR</button>
                    <button onClick={() => setActiveTab('strategy')} className={classNames("px-4 py-1.5 rounded-lg text-[10px] font-black transition-all flex items-center gap-2 transition-colors", activeTab === 'strategy' ? "bg-rose-600 text-white shadow-lg" : "text-slate-500 hover:text-[var(--theme-text)]")}><Brain size={12}/> AI STRATEGY</button>
                </div>
            </header>
            ...
            <div className="fixed bottom-0 left-0 right-0 bg-[var(--theme-header)] transition-colors duration-500 border-t border-[var(--theme-border)] transition-colors duration-500 flex justify-around items-center h-16 lg:hidden z-50 pb-safe">
            ...
            {selectedSector && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200">
                    ...
                    <div className="relative w-full max-w-sm bg-[var(--theme-header)] transition-colors duration-500 border border-slate-700 rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                        <div className="p-5 border-b border-[var(--theme-border)] transition-colors duration-500 bg-slate-850 flex justify-between items-center"><div className="flex-1 mr-2"><h3 className="text-lg font-black text-white leading-tight break-keep">{selectedSector.industry_name}</h3><span className={classNames("text-sm font-bold", parseFloat(selectedSector.change_rate) > 0 ? "text-rose-400" : "text-blue-400")}>{parseFloat(selectedSector.change_rate) > 0 ? '+' : ''}{selectedSector.change_rate}%</span></div><button onClick={() => setSelectedSector(null)} className="p-2 bg-slate-800 rounded-full hover:bg-slate-700 text-slate-400 transition-colors shrink-0"><X size={20} /></button></div>
