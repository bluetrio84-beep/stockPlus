...
const AdminSystemManagement = () => {
    ...
    return (
        <div className="flex-1 bg-[var(--theme-bg)] transition-colors duration-500 p-2 lg:p-8 overflow-hidden h-[100dvh] lg:h-full flex flex-col gap-3 lg:gap-6 relative pb-28 lg:pb-5">
            <header className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3 shrink-0">
                ...
                <div className="flex bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 p-1 rounded-xl shadow-lg self-stretch lg:self-auto overflow-x-auto no-scrollbar">
                ...
                <div className="flex-1 min-h-0 flex flex-col gap-3 lg:gap-4 animate-in fade-in duration-300">
                    <div className="flex flex-col lg:flex-row gap-2 shrink-0">
                        <div className="flex-1 flex gap-2">
                            <div className="flex-1 relative"><Search className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500" size={16} /><input type="text" placeholder="종목명/코드..." value={searchKeyword} onChange={(e) => setSearchKeyword(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && handleSearch()} className="w-full bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl pl-9 pr-4 py-2.5 text-xs lg:text-sm text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50" /></div>
                            <div className="flex items-center gap-2 bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl px-2 lg:px-3"><span className="text-[10px] lg:text-xs font-black text-slate-500 uppercase tracking-tighter whitespace-nowrap">Market</span><select value={marketFilter} onChange={(e) => setMarketFilter(e.target.value)} className="bg-transparent text-[11px] lg:text-sm text-white focus:outline-none font-bold cursor-pointer py-2"><option value="ALL" className="bg-[var(--theme-header)] transition-colors duration-500 text-white">전체</option><option value="KOSPI" className="bg-[var(--theme-header)] transition-colors duration-500 text-white">KOSPI</option><option value="KOSDAQ" className="bg-[var(--theme-header)] transition-colors duration-500 text-white">KOSDAQ</option></select></div>
                        </div>
                    ...
                    <div className="flex-1 min-h-0 bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-2xl overflow-hidden flex flex-col shadow-2xl">
                        <div className="overflow-auto custom-scrollbar flex-1">
                            <table className="w-full text-left border-collapse min-w-full">
                                <thead className="bg-[var(--theme-bg)] transition-colors duration-500/50 sticky top-0 z-10 shadow-sm"><tr className="text-[9px] lg:text-[10px] font-black text-slate-500 uppercase tracking-widest"><th className="px-2 lg:px-6 py-3 lg:py-4">Market</th><th className="px-2 lg:px-6 py-3 lg:py-4">Code</th><th className="px-2 lg:px-6 py-3 lg:py-4">Name</th><th className="px-2 lg:px-6 py-3 lg:py-4 text-right">Acts</th></tr></thead>
                        ...
                        {!searchKeyword && (
                            <div className="p-3 lg:p-4 border-t border-[var(--theme-border)] transition-colors duration-500 bg-[var(--theme-header)] transition-colors duration-500/80 flex items-center justify-between shrink-0">
            ...
            {activeTab === 'holidays' && (
                <div className="flex-1 min-h-0 flex flex-col gap-3 lg:gap-4 animate-in slide-in-from-bottom-2 duration-300">
                    <div className="flex justify-end items-center gap-2 shrink-0">
                        <div className="flex items-center gap-2 bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl px-2 lg:px-3"><span className="text-[10px] lg:text-xs font-black text-slate-500 uppercase tracking-tighter whitespace-nowrap">Year</span><select value={holidayYear} onChange={(e) => setHolidayYear(parseInt(e.target.value))} className="bg-transparent text-[11px] lg:text-sm text-white focus:outline-none font-bold cursor-pointer py-2 min-w-[60px] lg:min-w-[80px]">{[2026, 2027, 2028].map(y => <option key={y} value={y} className="bg-[var(--theme-header)] transition-colors duration-500 text-white">{y}년</option>)}</select></div>
            ...
            {activeTab === 'api' && (
                <div className="flex-1 min-h-0 flex flex-col gap-4 animate-in fade-in duration-300 overflow-hidden">
                    <div className="bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-3xl p-6 shadow-2xl shrink-0 flex flex-col lg:flex-row items-center gap-6">
                        ...
                        <div className="flex-1 w-full space-y-3">
                            ...
                            <div className="relative group">
                                ...
                                <input type="password" value={gitUrl} onChange={(e) => setGitUrl(e.target.value)} className="w-full bg-[var(--theme-bg)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl pl-12 pr-4 py-3 text-xs text-white focus:ring-2 focus:ring-amber-500/50 transition-all font-mono" placeholder="Enter Protected Git URL" />
                            </div>
                        </div>
                    ...
                    <div className="flex bg-[var(--theme-bg)] transition-colors duration-500/50 border border-[var(--theme-border)] transition-colors duration-500 p-1 rounded-2xl w-fit shrink-0">
                    ...
                    <div className="flex-1 min-h-0 bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-3xl overflow-hidden flex flex-col shadow-2xl">
                        <div className="p-4 bg-[var(--theme-bg)] transition-colors duration-500/50 border-b border-[var(--theme-border)] transition-colors duration-500 flex justify-between items-center shrink-0">
                        ...
                        <div className="flex-1 overflow-auto custom-scrollbar p-4 space-y-3">
                            {activeSubTab === 'apis' ? (
                                scannedData?.apis?.map((spec, idx) => (
                                    <div key={idx} className="bg-[var(--theme-bg)] transition-colors duration-500/50 border border-[var(--theme-border)] transition-colors duration-500 rounded-2xl overflow-hidden group">
                                        ...
                                        {expandedApi === idx && (
                                            <div className="px-5 pb-5 pt-2 border-t border-[var(--theme-border)] transition-colors duration-500/50 grid grid-cols-1 lg:grid-cols-2 gap-4 animate-in slide-in-from-top-2">
                                                <div className="space-y-2">
                                                    <h4 className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">▶ Data Mapping Spec</h4>
                                                    <table className="w-full text-left text-[10px] border-collapse bg-[var(--theme-header)] transition-colors duration-500/50 rounded-xl overflow-hidden">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <pre className="bg-[var(--theme-bg)] transition-colors duration-500 p-4 rounded-xl border border-[var(--theme-border)] transition-colors duration-500 text-[10px] font-mono text-emerald-400 overflow-x-auto">{spec.sample || '{}'}</pre>
                                                </div>
                                            </div>
                                        )}
                                    </div>
                                ...
                                scannedData?.tables?.map((table, idx) => (
                                    <div key={idx} className="bg-[var(--theme-bg)] transition-colors duration-500/50 border border-[var(--theme-border)] transition-colors duration-500 rounded-2xl overflow-hidden group">
                                        ...
                                        {expandedTable === idx && (
                                            <div className="px-5 pb-5 pt-2 border-t border-[var(--theme-border)] transition-colors duration-500/50 animate-in slide-in-from-top-2">
                                                <div className="space-y-2">
                                                    <h4 className="text-[10px] font-black text-emerald-400 uppercase tracking-widest">▶ Database Schema Spec</h4>
                                                    <div className="overflow-x-auto">
                                                        <table className="w-full text-left text-[10px] border-collapse bg-[var(--theme-header)] transition-colors duration-500/50 rounded-xl overflow-hidden min-w-[600px]">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200">
                    ...
                    <div className="relative w-full max-w-md bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-3xl shadow-2xl overflow-hidden">
                        <div className="p-5 lg:p-6 border-b border-[var(--theme-border)] transition-colors duration-500 bg-[var(--theme-header)] transition-colors duration-500 flex justify-between items-center text-white"><h3 className="text-base font-black uppercase italic">{editingStock ? '종목 수정' : '신규 종목'}</h3><button onClick={() => setIsModalOpen(false)}><X size={20}/></button></div>
                        <div className="p-6 lg:p-8 space-y-4">
                            <div className="space-y-1.5"><label className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Code <span className="text-rose-500">*</span></label><input type="text" value={formData.stockCode} readOnly={!!editingStock} onChange={(e) => setFormData({...formData, stockCode: e.target.value})} className={classNames("w-full bg-[var(--theme-bg)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl px-4 py-2.5 text-sm text-white font-mono", editingStock && "opacity-50")} /></div>
                            <div className="space-y-1.5"><label className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Name <span className="text-rose-500">*</span></label><input type="text" value={formData.stockName} onChange={(e) => setFormData({...formData, stockName: e.target.value})} className="w-full bg-[var(--theme-bg)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl px-4 py-2.5 text-sm text-white" /></div>
                            <div className="space-y-1.5"><label className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Market</label><select value={formData.marketType} onChange={(e) => setFormData({...formData, marketType: e.target.value})} className="w-full bg-[var(--theme-bg)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none font-bold"><option value="KOSPI" className="bg-[var(--theme-header)] transition-colors duration-500">KOSPI</option><option value="KOSDAQ" className="bg-[var(--theme-header)] transition-colors duration-500">KOSDAQ</option></select></div>
                        </div>
                        <div className="p-5 bg-[var(--theme-header)] transition-colors duration-500 flex gap-3"><button onClick={() => setIsModalOpen(false)} className="flex-1 py-2.5 bg-slate-800 text-slate-300 font-bold rounded-xl text-xs">취소</button><button onClick={handleSaveStock} className="flex-1 py-2.5 bg-indigo-600 text-white font-bold rounded-xl text-xs">저장</button></div>
                    </div>
                </div>
            )}
            ...
            {isUserModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200">
                    ...
                    <div className="relative w-full max-w-md bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-3xl shadow-2xl overflow-hidden">
                        <div className="p-5 lg:p-6 border-b border-[var(--theme-border)] transition-colors duration-500 bg-[var(--theme-header)] transition-colors duration-500 flex justify-between items-center text-white"><h3 className="text-base font-black uppercase italic">{editingUser ? '사용자 정보 수정' : '신규 사용자 등록'}</h3><button onClick={() => setIsUserModalOpen(false)}><X size={20}/></button></div>
                        <div className="p-6 lg:p-8 space-y-4 max-h-[70vh] overflow-y-auto custom-scrollbar">
                            <div className="space-y-1.5"><label className="text-[9px] font-black text-slate-500 uppercase tracking-widest flex items-center gap-1">ID (User Account) <span className="text-rose-500">*</span></label><input type="text" value={userFormData.usrId} readOnly={!!editingUser} onChange={(e) => setUserFormData({...userFormData, usrId: e.target.value})} className={classNames("w-full bg-[var(--theme-bg)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl px-4 py-2.5 text-sm text-white font-mono", editingUser && "opacity-50")} placeholder="사용자 아이디" /></div>
                            <div className="space-y-1.5"><label className="text-[9px] font-black text-slate-500 uppercase flex items-center gap-2 tracking-widest"><Key size={10} /> {editingUser ? '비밀번호 변경 (필요시)' : '비밀번호'} {!editingUser && <span className="text-rose-500">*</span>}</label><input type="password" value={userFormData.password} onChange={(e) => setUserFormData({...userFormData, password: e.target.value})} className="w-full bg-[var(--theme-bg)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl px-4 py-2.5 text-sm text-white" placeholder={editingUser ? "변경하지 않으려면 비워두세요" : "비밀번호 입력"} /></div>
                            <div className="space-y-1.5"><label className="text-[9px] font-black text-slate-500 uppercase tracking-widest">이름 (Full Name) <span className="text-rose-500">*</span></label><input type="text" value={userFormData.usrName} onChange={(e) => setUserFormData({...userFormData, usrName: e.target.value})} className="w-full bg-[var(--theme-bg)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl px-4 py-2.5 text-sm text-white font-black" /></div>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5"><label className="text-[9px] font-black text-slate-500 uppercase">권한</label><select value={userFormData.role} onChange={(e) => setUserFormData({...userFormData, role: e.target.value})} className="w-full bg-[var(--theme-bg)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none font-bold"><option value="USER">USER</option><option value="ADMIN">ADMIN</option></select></div>
                                <div className="space-y-1.5"><label className="text-[9px] font-black text-slate-500 uppercase">상태</label><select value={userFormData.useyn} onChange={(e) => setUserFormData({...userFormData, useyn: e.target.value})} className="w-full bg-[var(--theme-bg)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none font-bold"><option value="Y">ACTIVE</option><option value="N">BLOCKED</option></select></div>
                            </div>
                            <div className="space-y-1.5"><label className="text-[9px] font-black text-slate-500 uppercase">이메일 <span className="text-rose-500">*</span></label><input type="email" value={userFormData.email} onChange={(e) => setUserFormData({...userFormData, email: e.target.value})} className="w-full bg-[var(--theme-bg)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl px-4 py-2.5 text-sm text-white" /></div>
                            <div className="space-y-1.5"><label className="text-[9px] font-black text-slate-500 uppercase">연락처 <span className="text-rose-500">*</span></label><input type="text" value={userFormData.phoneNumber} onChange={(e) => setUserFormData({...userFormData, phoneNumber: e.target.value})} className="w-full bg-[var(--theme-bg)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl px-4 py-2.5 text-sm text-white" /></div>
                        </div>
            ...
            {isHolidayModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200">
                    ...
                    <div className="relative w-full max-w-md bg-[var(--theme-header)] transition-colors duration-500 border border-cyan-500/30 rounded-3xl shadow-2xl overflow-hidden">
                        <div className="p-5 lg:p-6 border-b border-[var(--theme-border)] transition-colors duration-500 bg-[var(--theme-header)] transition-colors duration-500 flex justify-between items-center text-white"><h3 className="text-base font-black uppercase italic text-cyan-400">{editingHoliday ? '공휴일 수정' : '공휴일 등록'}</h3><button onClick={() => setIsHolidayModalOpen(false)}><X size={20}/></button></div>
                        <div className="p-6 lg:p-8 space-y-4">
                            <div className="space-y-1.5"><label className="text-[9px] font-black text-slate-500 uppercase tracking-widest">날짜 선택 <span className="text-rose-500">*</span></label><div className="relative"><Calendar className="absolute left-3 top-1/2 -translate-y-1/2 text-cyan-500 pointer-events-none" size={16} /><input type="date" value={holidayFormData.holiday_date} onClick={(e) => e.target.showPicker && e.target.showPicker()} onChange={(e) => { const date = e.target.value; setHolidayFormData({...holidayFormData, holiday_date: date, holiday_year: new Date(date).getFullYear()}); }} className="w-full bg-[var(--theme-bg)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white focus:ring-2 focus:ring-cyan-500 [color-scheme:dark]" /></div></div>
                            <div className="space-y-1.5"><label className="text-[9px] font-black text-slate-500 uppercase tracking-widest">공휴일 명칭 <span className="text-rose-500">*</span></label><input type="text" value={holidayFormData.holiday_name} onChange={(e) => setHolidayFormData({...holidayFormData, holiday_name: e.target.value})} className="w-full bg-[var(--theme-bg)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl px-4 py-2.5 text-sm text-white focus:ring-2 focus:ring-cyan-500" placeholder="예: 삼일절" /></div>
                        </div>
            ...
            {errorPopup && (
                <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 animate-in fade-in duration-200">
                    ...
                    <div className="relative w-full max-w-sm bg-[var(--theme-header)] transition-colors duration-500 border border-rose-500/30 rounded-3xl shadow-2xl p-6 flex flex-col items-center text-center gap-4 animate-in zoom-in-95 duration-200">
