...
const MyPortfolioDashboard = () => {
    ...
    return (
        <div className="flex-1 bg-[var(--theme-bg)] transition-colors duration-500 p-4 lg:p-8 h-full overflow-y-auto custom-scrollbar flex flex-col gap-8 animate-in fade-in duration-700 relative">
            {/* 🔝 HEADER */}
            <header className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <button 
                        onClick={() => navigate('/')} 
                        className="w-12 h-12 bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 text-slate-400 hover:text-white rounded-2xl flex items-center justify-center transition-all active:scale-90 shadow-lg group"
                    >
                ...
                <div className="flex items-center gap-3">
                    <button onClick={fetchData} className="p-3 bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 text-slate-400 hover:text-white rounded-2xl transition-all active:scale-95 shadow-lg">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                <div className="bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-[2.5rem] p-5 lg:p-6 shadow-2xl flex flex-col items-center gap-2 relative overflow-hidden group">
                    ...
                    <div className="flex flex-wrap justify-center gap-x-5 gap-y-2 w-full pt-4 border-t border-[var(--theme-border)] transition-colors duration-500/50 mb-1">
                        {holdings.map((h, i) => {
                ...
                <div className="bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-[2.5rem] p-5 lg:p-6 shadow-2xl flex flex-col items-center gap-2 relative overflow-hidden group">
                    ...
                    <div className="w-full pt-4 border-t border-[var(--theme-border)] transition-colors duration-500/50 flex flex-col items-center gap-0.5 mb-1">
            ...
            <div className="bg-[var(--theme-header)] transition-colors duration-500/80 border border-indigo-500/40 rounded-[2.5rem] p-4 lg:p-6 flex flex-col gap-2 shadow-2xl relative overflow-hidden min-h-[500px] max-h-[650px]">
                ...
                <div className="relative z-10 w-full flex-1 overflow-y-auto custom-scrollbar pr-1 flex flex-col gap-2 mt-1">
                    {!parsedInsights ? (
                        ...
                        parsedInsights.map((insight, idx) => (
                            <div key={idx} className="bg-[var(--theme-bg)] transition-colors duration-500/50 border border-[var(--theme-border)] transition-colors duration-500 rounded-xl p-3 lg:p-4 flex flex-col xl:flex-row gap-4 w-full hover:border-indigo-500/30 transition-all duration-300">
                                <div className="flex-[1.2] border-b xl:border-b-0 xl:border-r border-[var(--theme-border)] transition-colors duration-500/50 pb-3 xl:pb-0 xl:pr-4">
                                    ...
                                    <div className="space-y-1.5">
                                        {Object.entries(insight.radar).filter(([k]) => k !== 'interpretation').map(([key, val]) => (
                                            <div key={key} className="flex items-center gap-3">
                                                ...
                                                <div className="flex-1 h-1.5 bg-[var(--theme-header)] transition-colors duration-500 rounded-full overflow-hidden">
                                                    <div 
                                    ...
                                    <div className="flex flex-wrap gap-1.5 justify-start">
                                        ...
                                        {insight.reasoning.map((r, i) => (
                                            <span key={i} className={classNames(
                                                ...
                                                "bg-[var(--theme-header)] transition-colors duration-500 text-slate-400 border-[var(--theme-border)] transition-colors duration-500"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-10">
                {holdings.map((stock, idx) => {
                    ...
                    return (
                        <div key={idx} className="bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-3xl p-6 shadow-xl hover:border-indigo-500/40 transition-all group flex flex-col gap-5">
                            ...
                            <div className="grid grid-cols-2 gap-4 bg-[var(--theme-bg)] transition-colors duration-500/50 p-4 rounded-2xl border border-white/5">
                                <div>
                            ...
                            <div className="flex flex-wrap gap-1.5 justify-start -mt-2">
                                {tacticalTags.map((tag, i) => (
                                    <span key={i} className={classNames(
                                        ...
                                        "bg-slate-800 text-slate-400 border-[var(--theme-border)] transition-colors duration-500"
                                    )}>
                                        {tag}
                                    </span>
                                ))}
            ...
            {isModalOpen && selectedInsight && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 lg:p-10 animate-in fade-in zoom-in-95 duration-300">
                    <div className="absolute inset-0 bg-[var(--theme-bg)] transition-colors duration-500/90 backdrop-blur-xl" onClick={() => setIsModalOpen(false)}></div>
                    <div className="relative bg-[var(--theme-header)] transition-colors duration-500 border-2 border-indigo-500/30 rounded-[2.5rem] w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
                        ...
                        <div className="flex-1 overflow-y-auto p-6 lg:p-10 space-y-10 custom-scrollbar text-white">
                            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                                {Object.entries(selectedInsight.radar).filter(([k]) => k !== 'interpretation').map(([key, val]) => (
                                    <div key={key} className="bg-[var(--theme-bg)] transition-colors duration-500/50 border border-[var(--theme-border)] transition-colors duration-500 rounded-3xl p-6 flex flex-col items-center gap-4 relative group hover:border-indigo-500/30 transition-all">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {/* Whale Tracker */}
                                <div className="bg-[var(--theme-bg)] transition-colors duration-500/50 border border-amber-500/20 rounded-[2rem] p-6 space-y-4">
                                ...
                                {/* Supply Flow */}
                                <div className="bg-[var(--theme-bg)] transition-colors duration-500/50 border border-indigo-500/20 rounded-[2rem] p-6 space-y-4">
                                ...
                                <div className="bg-[var(--theme-bg)] transition-colors duration-500/50 border border-emerald-500/20 rounded-[2rem] p-6 space-y-4">
                            ...
                            <div className="bg-[var(--theme-bg)] transition-colors duration-500/50 border border-white/5 rounded-[2.5rem] p-8 space-y-6">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <TrendingUp size={24} className="text-indigo-400" />
                                        <h3 className="text-white font-black text-lg uppercase tracking-widest">Multi-Whale Intelligence</h3>
                                    </div>
                                    <span className="text-[10px] text-slate-500 font-bold uppercase tracking-widest bg-[var(--theme-header)] transition-colors duration-500 px-3 py-1 rounded-full border border-white/5">Live Flow Analysis</span>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {/* Foreigner Stats */}
                                    <div className="bg-[var(--theme-header)] transition-colors duration-500 border border-indigo-500/20 rounded-[2rem] p-6 space-y-4 group/f">
                                        <div className="flex items-center gap-4">
                                        ...
                                        <div className="grid grid-cols-3 gap-2">
                                            <div className="bg-[var(--theme-bg)] transition-colors duration-500/50 p-3 rounded-xl border border-white/5 text-center">
                                    ...
                                    {/* Institution Stats */}
                                    <div className="bg-[var(--theme-header)] transition-colors duration-500 border border-cyan-500/20 rounded-[2rem] p-6 space-y-4 group/i">
                                        <div className="flex items-center gap-4">
                            ...
                            {/* 4. 요약 뉴스: Full Width */}
                            <div className="bg-[var(--theme-header)] transition-colors duration-500 border border-[var(--theme-border)] transition-colors duration-500 rounded-[2.5rem] p-8 space-y-6">
                                <div className="flex items-center gap-3">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                    {(selectedInsight.deep?.news || []).map((news, i) => (
                                        <div key={i} onClick={() => news.link && window.open(news.link, '_blank')} className={classNames("p-4 bg-[var(--theme-bg)] transition-colors duration-500/50 rounded-2xl border border-white/5 flex items-start gap-3 transition-all duration-300", news.link ? "cursor-pointer hover:border-indigo-500/50 hover:bg-indigo-500/5 group/news" : "")}>
                        ...
                        <div className="p-8 border-t border-white/5 bg-[var(--theme-bg)] transition-colors duration-500 flex justify-end">
